...
const mockUsers = [
  ...
  { id: 7, name: "Taylor", score: 3100, clanId: 2, avatar: "/placeholder-4jpab.png" },
  { id: 13, name: "Phoenix", score: 2980, clanId: 3, avatar: "/placeholder.svg?height=32&width=32" },
  { id: 3, name: "Jordan", score: 2850, clanId: 1, avatar: "/pixel-archer.png" },
  { id: 8, name: "Blake", score: 2750, clanId: 2, avatar: "/pixel-warrior.png" },
  { id: 19, name: "Echo", score: 2650, clanId: 4, avatar: "/placeholder.svg?height=32&width=32" },
  { id: 25, name: "Orion", score: 2580, clanId: 5, avatar: "/pixel-knight.png" },
  { id: 4, name: "Casey", score: 2450, clanId: 1, avatar: "/pixel-knight.png" },
  { id: 14, name: "Sage", score: 2380, clanId: 3, avatar: "/placeholder.svg?height=32&width=32" },
  { id: 9, name: "Avery", score: 2320, clanId: 2, avatar: "/pixel-shield.png" },
  { id: 20, name: "Storm", score: 2280, clanId: 4, avatar: "/placeholder.svg?height=32&width=32" },
  { id: 31, name: "Sage", score: 2150, clanId: 6, avatar: "/placeholder.svg?height=32&width=32" },
  { id: 5, name: "Riley", score: 2100, clanId: 1, avatar: "/pixel-rogue.png" },
  { id: 26, name: "Vega", score: 2050, clanId: 5, avatar: "/placeholder.svg?height=32&width=32" },
]
...
const mockClans = [
  {
    ...
    members: [
      ...
      { id: 6, name: "Morgan", avatar: "/pixel-paladin.png", status: "eliminated" },
    ],
    scoreHistory: [12000, 13500, 14200, 15420],
    activities: [
      { user: "Alex", action: "Completed Math Quiz", points: 150, time: "2 hours ago" },
      { user: "Sam", action: "Study Session", points: 200, time: "4 hours ago" },
      { user: "Jordan", action: "Flashcard Review", points: 100, time: "6 hours ago" },
    ],
  },
  {
    id: 2,
    ...
    members: [
      { id: 7, name: "Taylor", avatar: "/placeholder-4jpab.png", status: "active" },
      ...
      { id: 12, name: "River", avatar: "/pixel-armor.png", status: "eliminated" },
    ],
    scoreHistory: [15200, 14800, 14500, 14890],
    activities: [
      { user: "Taylor", action: "Physics Problem Set", points: 180, time: "1 hour ago" },
      { user: "Blake", action: "Literature Essay", points: 220, time: "3 hours ago" },
    ],
  },
  {
    id: 3,
    ...
    members: [
      { id: 13, name: "Phoenix", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 14, name: "Sage", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 15, name: "Nova", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 16, name: "Zara", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 17, name: "Kai", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 18, name: "Luna", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
    ],
    scoreHistory: [12800, 13200, 13400, 13750],
    activities: [
      { user: "Phoenix", action: "Chemistry Lab", points: 190, time: "30 minutes ago" },
      { user: "Nova", action: "History Timeline", points: 160, time: "2 hours ago" },
    ],
  },
  {
    id: 4,
    ...
    members: [
      { id: 19, name: "Echo", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 20, name: "Storm", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 21, name: "Blaze", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 22, name: "Frost", avatar: "/placeholder.svg?height=32&width=32", status: "eliminated" },
      { id: 23, name: "Ember", avatar: "/placeholder.svg?height=32&width=32", status: "eliminated" },
      { id: 24, name: "Mist", avatar: "/placeholder.svg?height=32&width=32", status: "eliminated" },
    ],
    scoreHistory: [13500, 13200, 12800, 12980],
    activities: [
      { user: "Echo", action: "Biology Quiz", points: 140, time: "1 hour ago" },
      { user: "Storm", action: "Vocabulary Test", points: 120, time: "5 hours ago" },
    ],
  },
  {
    id: 5,
    ...
    members: [
      ...
      { id: 26, name: "Vega", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 27, name: "Atlas", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 28, name: "Iris", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 29, name: "Zephyr", avatar: "/placeholder.svg?height=32&width=32", status: "eliminated" },
      { id: 30, name: "Cosmos", avatar: "/placeholder.svg?height=32&width=32", status: "eliminated" },
    ],
    scoreHistory: [10800, 11200, 11400, 11650],
    activities: [
      { user: "Orion", action: "Algebra Practice", points: 130, time: "3 hours ago" },
      { user: "Vega", action: "Science Fair Project", points: 250, time: "7 hours ago" },
    ],
  },
  {
    id: 6,
    ...
    members: [
      { id: 31, name: "Sage", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 32, name: "Raven", avatar: "/placeholder.svg?height=32&width=32", status: "active" },
      { id: 33, name: "Willow", avatar: "/placeholder.svg?height=32&width=32", status: "eliminated" },
      { id: 34, name: "Cedar", avatar: "/placeholder.svg?height=32&width=32", status: "eliminated" },
      { id: 35, name: "Rowan", avatar: "/placeholder.svg?height=32&width=32", status: "eliminated" },
      { id: 36, name: "Aspen", avatar: "/placeholder.svg?height=32&width=32", status: "eliminated" },
    ],
    scoreHistory: [11200, 10800, 10500, 10420],
    activities: [
      { user: "Sage", action: "Reading Comprehension", points: 110, time: "4 hours ago" },
      { user: "Raven", action: "Essay Writing", points: 180, time: "8 hours ago" },
    ],
  },
]
...
export default function ClansLeaderboard() {
  ...
  const [selectedClan, setSelectedClan] = useState<(typeof mockClans)[0] | null>(null)
  ...
  const avgScore = Math.round(mockClans.reduce((sum, clan) => sum + clan.totalScore, 0) / totalClans)

  const formatTokenAmount = (amount: number, token: typeof SCORE_TOKEN | typeof VAULT_TOKEN) => {
  ...
  const MemberRing = ({ members }: { members: (typeof mockClans)[0]["members"] }) => {
    const positions = [
          ...
          <div key={member.id} className="absolute" style={positions[index]}>
            <Avatar
              className={`w-8 h-8 border-2 pixel-border ${
                member.status === "eliminated" ? "eliminated border-muted" : "border-primary"
              }`}
            >
              <AvatarImage src={member.avatar || "/placeholder.svg"} alt={member.name} />
              <AvatarFallback className="pixel-font text-xs">{member.name.slice(0, 2).toUpperCase()}</AvatarFallback>
            </Avatar>
          </div>
        ))}
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          {sortedUsers.slice(0, 10).map((user, index) => {
            ...
            return (
              <div key={user.id} className="flex items-center gap-3 p-2 bg-muted/20 rounded pixel-border">
                <div className="flex items-center gap-2 w-20">
                  <span className="pixel-font text-sm font-bold">#{index + 1}</span>
                  <Avatar className="w-6 h-6">
                    <AvatarImage src={user.avatar || "/placeholder.svg"} alt={user.name} />
                    <AvatarFallback className="pixel-font text-xs">{user.name.slice(0, 2)}</AvatarFallback>
                  </Avatar>
                </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-2">
                      <span className="pixel-font text-sm font-medium">{user.name}</span>
                      <span className="pixel-font text-xs text-muted-foreground">
                        {clan?.flag} {clan?.name}
                      </span>
                    </div>
                    <span className="pixel-font text-sm font-bold text-primary">
                      {formatTokenAmount(user.score * Math.pow(10, SCORE_TOKEN.decimals), SCORE_TOKEN)}
                    </span>
                  </div>
  ...
  const ClanRankingsChart = () => {
    const sortedClans = [...mockClans].sort((a, b) => b.totalScore - a.totalScore)
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          {sortedClans.map((clan, index) => {
            ...
            return (
              <div key={clan.id} className="flex items-center gap-3 p-3 bg-muted/20 rounded pixel-border">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="pixel-font text-sm font-medium">{clan.name}</span>
                      <Badge variant="outline" className="pixel-font text-xs">
                        {clan.remainingMembers}/{clan.totalMembers} active
                      </Badge>
                    </div>
                    <span className="pixel-font text-sm font-bold text-primary">
                      {formatTokenAmount(clan.totalScore * Math.pow(10, SCORE_TOKEN.decimals), SCORE_TOKEN)}
                    </span>
                  </div>
  ...
  const DividendVaultWidget = ({ clan, isCompact = false }: { clan: (typeof mockClans)[0]; isCompact?: boolean }) => {
      ...
      return (
        <div className="flex items-center justify-between p-2 bg-muted/20 rounded pixel-border">
          <div className="flex items-center gap-2">
            ...
            <span className="pixel-font text-xs text-muted-foreground">Vault:</span>
            <span className="pixel-font text-xs font-bold">
              {formatTokenAmount(clan.dividendVault.totalBalance * Math.pow(10, VAULT_TOKEN.decimals), VAULT_TOKEN)}
            </span>
          </div>
          {hasClaimableRewards && (
            <Button
          ...
          {isMember && clan.dividendVault.userClaimable > 0 && claimedRewards.has(clan.id) && (
            <Badge variant="outline" className="pixel-font text-xs">
              Claimed
            </Badge>
          )}
      ...
      <Card className="pixel-border">
        ...
        <CardContent className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <p className="pixel-font text-xs text-muted-foreground">Total Balance</p>
              <p className="pixel-font text-lg font-bold text-primary pixel-font">
                {formatTokenAmount(clan.dividendVault.totalBalance * Math.pow(10, VAULT_TOKEN.decimals), VAULT_TOKEN)}
              </p>
            </div>
            <div>
              <p className="pixel-font text-xs text-muted-foreground">Your Share</p>
              <p className="pixel-font text-lg font-bold text-accent pixel-font">
                {isMember
                  ? formatTokenAmount(
                      clan.dividendVault.userClaimable * Math.pow(10, VAULT_TOKEN.decimals),
                      VAULT_TOKEN,
                    )
          ...
          <div className="space-y-2">
            <h5 className="pixel-font text-sm font-bold text-muted-foreground">Member Contributions</h5>
                ...
                return (
                  <div
                    ...
                    className={`flex items-center justify-between p-2 rounded pixel-border text-xs ${
                      isCurrentUser ? "bg-primary/10 border-primary" : "bg-muted/10"
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`pixel-font ${isCurrentUser ? "font-bold text-primary" : ""}`}>
                        {member.name}
                      </span>
                    ...
                    <div className="text-right">
                      <p className="pixel-font font-bold">
                        {formatTokenAmount(contribution * Math.pow(10, VAULT_TOKEN.decimals), VAULT_TOKEN)}
                      </p>
          ...
          <div className="text-xs pixel-font text-muted-foreground">
            ...
            <p>
              Total distributed:{" "}
              {formatTokenAmount(clan.dividendVault.totalDistributed * Math.pow(10, VAULT_TOKEN.decimals), VAULT_TOKEN)}
            </p>
          </div>

          {hasClaimableRewards && (
            <Button onClick={(e) => handleClaimRewards(clan.id, e)} className="w-full pixel-border pixel-font">
              <Gift className="w-4 h-4 mr-2" />
              Claim{" "}
              {formatTokenAmount(clan.dividendVault.userClaimable * Math.pow(10, VAULT_TOKEN.decimals), VAULT_TOKEN)}
            </Button>
          )}
    ...
    <div className="min-h-screen bg-background p-4 lg:p-8">
      ...
      <header className="mb-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
          <div>
            <h1 className="text-4xl lg:text-5xl font-bold pixel-font text-primary mb-2">残酷学分！</h1>
          ...
          <Card className="pixel-border">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground pixel-font">Total Clans</p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold pixel-font">
                  {formatTokenAmount(avgScore * Math.pow(10, SCORE_TOKEN.decimals), SCORE_TOKEN).split(" ")[0]}
                </p>
                <p className="text-sm text-muted-foreground pixel-font">Avg {SCORE_TOKEN.symbol}</p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold pixel-font">
                      {mockClans.reduce((sum, clan) => sum + clan.remainingMembers, 0)}
                    </p>
                    <p className="text-sm text-muted-foreground pixel-font">Active Warriors</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold pixel-font text-red-500">
                      {mockClans.reduce((sum, clan) => sum + (clan.totalMembers - clan.remainingMembers), 0)}
                    </p>
                    <p className="text-sm text-muted-foreground pixel-font">Eliminated</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 pt-3 border-t border-muted">
                <p className="text-xs text-muted-foreground pixel-font mb-2">Daily Retention (Last 7 Days)</p>
                <div className="flex items-end gap-1 h-8">
                  {[95, 89, 84, 78, 71, 65, 58].map((percentage, index) => (
                    <div key={index} className="flex-1 flex flex-col items-center">
                      ...
                      />
                      <span className="text-xs pixel-font text-muted-foreground mt-1">{percentage}%</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        {mockClans.map((clan) => (
          <Card
            ...
            className={`pixel-border hover:shadow-lg transition-all duration-200 hover:-translate-y-1 cursor-pointer group ${
              isUserClan(clan.id) ? "ring-2 ring-primary ring-offset-2 ring-offset-background" : ""
            }`}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {isUserClan(clan.id) && (
                        <Badge variant="default" className="pixel-font text-xs bg-primary">
                          MY CLAN
                        </Badge>
                      )}
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="pixel-font text-sm">Rank #{clan.rank}</span>
                ...
                <div className="flex items-center gap-2">
                  <Badge variant="secondary" className="pixel-font text-xs">
                    {formatTokenAmount(clan.totalScore * Math.pow(10, SCORE_TOKEN.decimals), SCORE_TOKEN).split(" ")[0]}
                  </Badge>
                  {canJoinClan(clan.id) && (
                    <Button
                      size="sm"
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between items-center text-sm">
                <div className="pixel-font">
                  <span className="text-primary font-bold">{clan.remainingMembers}</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-xs text-muted-foreground pixel-font">Score Trend</span>
      ...
      {/* Create Clan Dialog */}
      <Dialog open={showCreateClan} onOpenChange={setShowCreateClan} className="sm:max-w-4xl">
          ...
          <form onSubmit={handleCreateClan} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setNewClanForm((prev) => ({ ...prev, name: e.target.value }))}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setNewClanForm((prev) => ({ ...prev, flag: e.target.value }))}
                placeholder="🏴‍☠️"
                className="pixel-border pixel-font text-center text-2xl"
                required
                maxLength={2}
              />
              <p className="text-xs text-muted-foreground pixel-font">Choose an emoji to represent your clan</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e) => setNewClanForm((prev) => ({ ...prev, description: e.target.value }))}
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => setNewClanForm((prev) => ({ ...prev, initialLeverage: value }))}
              >
            ...
            <div className="bg-muted/20 p-3 rounded pixel-border">
              <h4 className="pixel-font font-bold text-sm mb-2">Creation Cost</h4>
      ...
      {/* Clan Detail Dialog */}
      <Dialog open={!!selectedClan} onOpenChange={() => setSelectedClan(null)} className="max-w-4xl">
          ...
          {selectedClan && (
            <>
              ...
              {canJoinClan(selectedClan.id) && (
                <Button onClick={(e) => handleJoinClan(selectedClan.id, e)} className="w-full pixel-border pixel-font">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Card className="pixel-border">
                    <CardContent className="p-4">
                      <h4 className="pixel-font font-bold mb-2">Total {SCORE_TOKEN.symbol}</h4>
                      <p className="text-2xl font-bold text-primary pixel-font">
                        {formatTokenAmount(selectedClan.totalScore * Math.pow(10, SCORE_TOKEN.decimals), SCORE_TOKEN)}
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="pixel-border">
                    <CardContent className="p-4">
                      ...
                      <p className="text-2xl font-bold text-accent pixel-font">{selectedClan.leverage}x</p>
                    </CardContent>
                  </Card>
                </div>
                    ...
                    {selectedClan.members.map((member) => (
                      <div
                        ...
                        className={`flex items-center gap-3 p-2 rounded pixel-border ${
                          member.status === "eliminated" ? "eliminated bg-muted/50" : "bg-card"
                        }`}
                      >
                ...
                {/* Recent Activities */}
                <div>
                  <h4 className="pixel-font font-bold mb-3">Recent Activities</h4>
                  <div className="space-y-2">
                    {selectedClan.activities.map((activity, index) => {
                      ...
                      return (
                        ...
                        >
                          <div>
                            <p className="pixel-font text-sm font-medium">{activity.user}</p>
                            <p className="pixel-font text-xs text-muted-foreground">{activity.action}</p>
                          </div>
                          <div className="text-right">
                            <p className="pixel-font text-sm font-bold text-accent">
                              +{formatTokenAmount(activity.points * Math.pow(10, SCORE_TOKEN.decimals), SCORE_TOKEN)}
                            </p>
                            <p className="pixel-font text-xs text-muted-foreground">
                              Vault: +
                              {formatTokenAmount(
                                dividendContribution * Math.pow(10, VAULT_TOKEN.decimals),
                                VAULT_TOKEN,
                              )}
                            </p>
                            <p className="pixel-font text-xs text-muted-foreground">{activity.time}</p>
                          </div>
                        </div>
                      )
                    })}
